...
--
myTerminal      = "kitty"
myEmacs         = "/usr/bin/emacsclient -c -a 'emacs' "
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- launch rofi
    , ((altMask,            xK_s     ),  spawn "rofi -show drun")
    ...
    -- Restart xmonad
    , ((altMask,               xK_r     ), spawn "xmonad --recompile; xmonad --restart")
