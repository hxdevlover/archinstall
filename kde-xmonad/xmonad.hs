...
+ My XMonad Config file for KDE Plasma Desktop.
+ Visit https://github.com/hxdevlover/
...
--
myNormalBorderColor  = "#393E46" -- Border of inactive window.
myFocusedBorderColor = "#B088F9" -- Border of focused window.
...
myManageHook = composeAll . concat $
    ...
    , [ className   =? "Xfce4-appfinder"       --> doIgnore >> doCenterFloat ]
    , [ className   =? "thunar"                --> doIgnore >> doCenterFloat ]
    , [ className   =? "cfw"                   --> doIgnore >> doCenterFloat ]
